...
$txt_mailsql_does_not_look_like_a_mailbox_login = array(
	...
	"nl" => "Dit lijkt niet op een mailbox login...",
...
$txt_mailsql_mailbox_does_not_exists_in_db = array(
	...
	"nl" => "Mailbox bestaat niet in database!",
	...
	"es" => "El buz髇 no existe en la base de datos!",
...
$txt_mailsql_pass_are_made_only_with_std_chars_and_nums_and_should_be_6to16_long = array(
	"fr" => "Les mots de passes sont fait uniquement de caract鑢es standard (a-zA-Z0-9) et doivent etre entre 6 et 16 caract鑢e de longueur.",
	...
	"zh" => "密码应该仅由字母和数字组成(a-zA-Z0-9)，长度应该在6到16个字符。",
...
+	"es" => "La contrase馻 s髄o puede contener letras y n鷐eros (a-zA-Z0-9) y debe contener entre 6 y 16 caracteres.",
...
$txt_mailsql_incorrect_redirection1_thisis_not_a_correct_email_format = array(
	...
	"nl" => "Incorecte redirectie 1: dit is geen correct emailbox formaat.",
	...
	"es" => "Redirecci髇 1 incorrecta. Formato de email incorrecto!",
...
$txt_mailsql_incorrect_redirection1_thisis_not_a_correct_email_format = array(
	...
	"nl" => "Incorecte redirectie 2: dit is geen correct emailbox formaat.",
