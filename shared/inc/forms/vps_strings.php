...
$txt_method_getvpsstate_failed_not_running = array(
	...
	"nl" => "kon remote status niet verkrijgen (Method getVPSState() failed). Misschien is de vps niet actief...",
	...
	"zh" => "ÎÞ·¨µÃµ½Ô¶³ÌÖ÷»úµÄÔËÐÐ×´Ì¬(º¯ÊýgetVPSState()ÔËÐÐÊ§°Ü)¡£¿ÉÄÜVPSÃ»ÓÐÔËÐÐ...",
...
$txt_couldnot_connect_to_soap_server_http_error = array(
	...
	"nl" => "kon remote status niet verkrijgen: kon geen verbinding maken met de SOAP server (HTTP error).",
	...
	"zh" => "ÎÞ·¨µÃµ½Ô¶³ÌÖ÷»úµÄÔËÐÐ×´Ì¬£ºÎÞ·¨Á¬½Óµ½SOAP·þÎñÆ÷(HTTP error)¡£",
...
$txt_reinstalling_operating_system = array(
	...
	"nl" => "Herinstallatie operating system...",
...
$txt_your_vps_was_first_registered_on_the = array(
	...
	"nl" => "Jouw VPS was voor het eerst geregistreerd op: ",
...
$txt_please_wait_until_fsck_finished = array(
	...
	"nl" => "wacht alsjeblieft tot file system check is klaar is.",
...
$txt_please_wait_until_reinstall_os_finished = array(
	...
	"nl" => "Wacht alsjeblieft tot de herinstallatie van het operating system reinstallation klaar is.",
...
$txt_to_do_a_file_system_check_or_operating_system_reinstallation = array(
	...
	"nl" => "Om een filesystem check of herinstallatie van een besturings systeem te doen dien je eerst je server uit te schakelen of vernietigd te worden",
	...
	"zh" => "Èç¹ûÒª×öÎÄ¼þÏµÍ³¼ì²é»òÕßÖØÐÂ°²×°²Ù×÷ÏµÍ³£¬ÄúÐèÒªÏÈ¹Ø±Õ»òÕßÏú»ÙÄúµÄVPS¡£",
...
$txt_operating_system_type_not_supported = array(
	...
	"nl" => "Operating system type niet ondersteund",
...
$txt_reinstall_operating_system = array(
	...
	"nl" => "Herinstalleer operating system:",
...
$txt_to_access_to_your_console_first_setup_a_ssh_password = array(
	...
	"nl" => "Om toegang te krijgen tot de console, zet eerst een ssh password of key op, en ssh daarna naar:",
	...
	"zh" => "ÒªÁ¬½Óµ½ÄúµÄ¿ØÖÆÌ¨£¬ÄúÐèÒªÊ×ÏÈÉèÖÃÒ»¸öSSHµÇÂ½ÃÜÂë»òÕßÃÜÔ¿£¬È»ºóÊ¹ÓÃSSHÁ¬½Óµ½£º",
