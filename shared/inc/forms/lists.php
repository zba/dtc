...
$list_path = $admin_path."/".$edit_domain."/lists/".$_REQUEST["edit_mailbox"];
...
function drawAdminTools_MailingLists($domain){
	...
	// Display the list of mailinglists
	...
	// Display the edit form of an existing list
	if(isset($_REQUEST["edit_mailbox"]) && $_REQUEST["edit_mailbox"] != ""){
		...
		$txt .= "
<table border=\"1\"><tr><td align=\"right\" onmouseover=\"return escape('".$txt_lists_hlp_list_name[$lang]."')\">
