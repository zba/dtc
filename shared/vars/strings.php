...
$txt_your_vps_has_expired_on_the = array(
	...
	"it" => "TRANS Your VPS has expired on the: ",
...
$txt_please_renew_with_one_of_the_following_options = array(
	...
	"it" => "TRANS Please renew with one of the following options: ",
...
$txt_your_vps_will_expire_on_the = array(
	...
	"it" => "TRANS Your VPS will expire on the: ",
...
$txt_cpu_and_network_usage = array(
	...
	"it" => "TRANS CPU and Network usage:",
...
$txt_start_stop_vps = array(
	...
	"it" => "TRANS Start and stop of your VPS:",
...
$txt_please_wait_until_fsck_finished = array(
	...
	"it" => "TRANS Please wait until file system check is finished first.",
...
$txt_please_wait_until_reinstall_os_finished = array(
	...
	"it" => "TRANS Please wait until operating system reinstallation is finished first.",
...
$txt_gracefully_shutdown_xm_shutdown = array(
	...
	"it" => "TRANS Gracefully shutdown (xm shutdown)",
...
$txt_immediate_kill_xm_destroy = array(
	...
	"it" => "TRANS Immediate kill (xm destroy)",
...
$txt_to_do_a_file_system_check_or_operating_system_reinstallation = array(
	...
	"it" => "TRANS To do a file system check or an operating system reinstallation, you need to shutdown or destroy your server first.",
...
$txt_file_system_check_fsck = array(
	...
	"it" => "TRANS File system check (fsck)",
...
$txt_operating_system_type_not_supported = array(
	...
	"it" => "TRANS Operating system type not suppoorted",
...
$txt_currently_installed_operating_system = array(
	...
	"it" => "TRANS Currently installed operating system: ",
...
$txt_physical_console_last_display_and_ssh_access = array(
	...
	"it" => "TRANS Physical console last display and ssh access:",
...
$txt_to_access_to_your_console_first_setup_a_ssh_password = array(
	...
	"it" => "TRANS To access to your console, first setup a ssh password or key above, and then ssh to:",
...
$txt_general_virtual_admin_edition = array(
	...
	"zh" => "ĞéÄâ¹ÜÀíÈËÔ±ÅäÖÃ <i>\"$adm_login\"</i>",
...
$txt_domains_configuration_title = array(
	...
	"zh" => "¶ÔÃ¿Ò»¸ö <i>\"$adm_login\"</i>¡¡ÇøÓòµÄÅäÖÃ",
...
Die Angabe \"default\" bedeutet, dass Sie den aktuellen Server nutzen wollen.",
	"zh" => "×¢Òâ! Èç¹ûÄú°ÑÒ»Ğ©´íÎóµÄÊı¾İÊäÈë¿Õ¸ñ£¬ÄÇÃ´£¬ÄúµÄÃüÁî½«²»ÄÜÖ´ĞĞ(ÀıÈç:ÍøÖ·ºÍÊäÈëĞÅÏ¢)<br>
...
subdomain to point to it. First, enter login and password here: ",
	...
	"zh" => "¸ù¾İÄúµÄĞèÒª£¬¿ÉÒÔÒ£¿ØÉèÖÃÄúµÄ¸±ÓòÃû¡£¾Ù¸öÀı×ÓÀ´½²£¬Èç¹ûÄúÓĞÒ»¸ö¼ÒÍ¥Á¬½Ó¸Ä±äµØÖ·²¢ÇÒÏ£Íû¸±ÓòÃûÖ¸ÏòËü¡£Ê×ÏÈ£¬ÔÚÕâÀïÌîÈëµÇÂ¼ºÍÃÜÂë: ",
...
$txt_subdom_nameserver_for = array(
	"fr" => "Ce subdomain est une entrÃ©e du nameserver (NS) pour le subdomain suivant  ",
	...
	"it" => "Questo subdomain Ã¨ un'entrata del nameserver (NS) per il seguente subdomain: ",
	"nl" => "Dit subdomain is een nameserver(ns) ingang voor volgende subdomain: ",
	"ru" => "Ğ­Ñ‚Ğ¸Ğ¼ subdomain Ğ±ÑƒĞ´ĞµÑ‚ Ğ²Ñ…Ğ¾Ğ´ nameserver (ns) Ğ´Ğ»Ñ following subdomain: ",
	"de" => "Dieses subdomain ist eine nameserver (NS) Eintragung fÃ¼r das folgende subdomain: ",
...
network clock and do it at 9,19,29,39,49 and 59 of each hours).",
	...
	"zh" => "È»ºóÔÚÄãµÄUnix¡¡system crontab (lynx-ssl ÊÇĞèÒªµÄ)Àï¼òµ¥µÄ¼ÓÈëÏÂÁĞ
³ÌĞò¡£ÍÆ¼öµÄÊ±¼äÊÇ½éÓÚ£³£°·ÖÖÓµ½£²Ğ¡Ê±¡£Çë²»Òª¶àÓÚÃ¿Ê®·ÖÖÓ³¢ÊÔÒ»´Î£¬DTC½«²»Óè¹ÜÀíÓòÃûÇøÓòÎÄ¼şÈç¹û³¢ÊÔ¹ıÓÚÆµ·±£¨½¨Òé£ºÔÚÄúµÄ·şÎñÆ÷ÉÏ½¨Á¢ÍøÂçÄÖÖÓ²¢ÇÒÔÚÃ¿Ğ¡Ê±µÄ9,19,29,39,49 ºÍ 59·ÖÖÓ³¢ÊÔ¡£",
...
$txt_subdom_windowsusers = array(
	...
	"zh" => "Î¢Èí´°¿ÚÊ¹ÓÃÕß¿ÉÒÔÊ¹ÓÃÏÂÁĞURL£º",
