...
$txt_transfer_du = array(
	"fr" => "TransfХre et utilisation disque :",
...
$txt_your_hosting_account = array(
	"fr" => "Votre contract d'hИbergement :",
...
$txt_please_tell_if_info_not_ok = array(
	"fr" => "Merci de nous avertir ci les informations ce-dessous n'Иtaient pas correct :",
...
profiter des Иventuelles ajouts, et que vous ne tiriez pas de profit
de cet outil. Nous (chez GPLHost) croyons en l'effort pour le
logiciel libre, et nous espИrons que notre contribution vas encourager
le developpement d'autre logiciel. Nous avons aussi considИrИ le fait
...
effort de developpement a la communautИ.<br><br>

<font size=\"+1\"><u>2. Emails</u></font><br>
<u>2.1. A quoi ca sert ?</u><br><br>
Vous pouvez ajouter, supprimer, ou modifier des boites Иlectronique
avec cet outil.<br><br>

<u>2.2. Redirection et livraison en local</u><br><br>
Chaque boite email peut Йtre redirigИ vers au moins une adresse email,
ce que signifit que lorsqu'un message sera recu, celui-ci sera retransmit
ver une ou deux adresse()s de courrier Иlectronique. La case a cochИ
\"DИliver en local\" indique si oui on non les message pour cette boite
...
pas a voire cela fonctionner immИdiatement : nous devons valider
...
sanctions pouraient Йtre immИdiates. Rappelez vous que nous
...
un deamon spИcialisИ (sympa, marjodomo, etc...).<br><br>
...
vous pourez crИer des adresses de la forme :
<pre>
