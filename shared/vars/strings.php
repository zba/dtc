...
$txt_mail_alias_new_item_title = array(
	...
	"de" => "neue E-Mail-Gruppe einrichten",
...
$txt_mail_alias_list_current_aliases = array(
	...
	"de" => "Übersicht über Ihre E-Mail-Gruppen",
...
$txt_there_is_a_ssh_login_by_that_name = array(
	...
	"de" => "Es gibt bereits ein SSH-Login mit diesem Namen",
...
$txt_there_is_a_ftp_login_by_that_name = array(
	...
	"de" => "Es gibt bereits ein FTP-Login mit diesem Namen",
...
$txt_there_is_a_mailbox_by_that_name = array(
	...
	"de" => "Es gibt bereits eine Mailbox mit diesem Namen",
...
$txt_server_statistic_graphs = array (
	...
	"de" => "Statistik-Diagramme des Servers",
	"zh" => "·şÎñÆ÷Í³¼ÆÍ¼",
...
$txt_user_login_incorrect = array (
	...
	"zh" => "ÓÃ»§µÇÂ½Ãû¸ñÊ½²»ÕıÈ·¡£ÇëÊ¹ÓÃÊı×Ö»ò×ÖÄ¸£¬²¢ÇÒÊÇ4µ½16¸ö×Ö·ûÊıÖ®¼ä¡£",
...
$txt_password_format_incorrect = array (
	...
	"de" => "ungültiges Passwort. Bitte benutzen Sie nur Buchstaben und Ziffern sowie 4 bis 16 Zeichen.",
	"zh" => "ÃÜÂë¸ñÊ½²»ÕıÈ·¡£ÇëÊ¹ÓÃÊı×Ö»ò×ÖÄ¸£¬²¢ÇÒÊÇ4µ½16¸ö×Ö·ûÊıÖ®¼ä¡£",
...
$txt_could_not_find_vps_server_in_db = array (
	...
	"zh" => "ÔÚÊı¾İ¿âÖĞÃ»ÓĞÕÒµ½VPSµÄÏà¹ØÅäÖÃ",
...
$txt_import_a_domain_for_this_user = array(
	...
	"de" => "Wine Domain-Datei fuer diesen Benutzer importieren:",
	"ro" => "Importeza un fisier de domeniu pentru acest utilizator:",
	"zh" => "ÎªÕâ¸öÓÃ»§µ¼ÈëÒ»¸öÓòÎÄ¼ş£º",
...
$txt_export_domain_to_file = array(
	...
	"de" => "Diese Domain in eine Datei exportieren",
	"ro" => "Exporteaza acest domeniu ”n un fi&#351;ier",
	"zh" => "½«Õâ¸öÓòµ¼³öµ½Ò»¸öÎÄ¼ş",
...
$txt_iframe_nts=array(
	...
	"es" => "Estad&iacute;sticas del tr&aacute;fico de red ",
...
$txt_iframe_mqg=array(
	...
	"es" => "Gr&aacute;fico de la cola de correo ",
...
$txt_package_un_size=array(
	...
	"es" => "Tama&ntilde;o descomprimido ",
...
$txt_Whois_editor_of =array(
	...
	"de" => "Internet-Whois Handle-Verwaltung",
	"ro" => "TRANS Internet Whois Nick Handles management",
	"zh" => "»¥ÁªÍøWhoisĞÅÏ¢¹ÜÀí£º",
	"pl" => "Zarz±dzanie danymi Whois:",
	"se" => "TRANS SVENSKA",
	"es" => "Manejo de Internet Whois Nick Handles:",
	"pt" => "TRANS "
);
	...
	"de" => "Wiederverkäufer Unterkonten",
	"ro" => "Subconturi ###reseller",
	"zh" => "×ÓÕË»§",
	"pl" => "Subkonta resellerskie:",
	"se" => "TRANS SVENSKA",
	"es" => "Sub-cuentas de revendedor",
...
$txt_edit_mailing_lists_of_domain = array(
	...
	"de" => "Mailinglisten der Domain bearbeiten:",
...
$txt_registry_selection=array (
	...
	"nl" => "Registry selectie ",
	"ru" => "TRANS ",
	"de" => "Auswahl der Registrierung ",
	"ro" => "###Alegere registry ",
	"zh" => "×¢²áÑ¡Ïî£º",
	"pl" => "Panel rejestracji:",
	"se" => "TRANS SVENSKA",
	"es" => "Selecci&oacute;n de registro: ",
	"pt" => "TRANS "
	);
...
$txt_dtc_configuration=array (
	...
	"pl" => "Konfiguracja DTC",
	"se" => "TRANS SVENSKA",
	"es" => "Configuraci&oacute;n de DTC ",
	"pt" => "TRANS "
	);
...
$txt_user_administration=array (
	...
	"se" => "TRANS SVENSKA",
	"es" => "Administraci&oacute;n de Usuario ",
	"pt" => "TRANS "
	);
...
$txt_domain_config = array(
	...
	"nl" => "Domein configuratie ",
	"ru" => "TRANS ",
	"de" => "Domain-Konfiguration",
...
$txt_email_pass_error = array (
  ...
  "se" => "Fel Lösenord!",
  "es" => "Login o contrase&ntilde;a err&oacute;neos",
  "pt" => "TRANS "
...
$txt_goto_client_panel = array(
  ...
  "nl" => "Ga naar client panel ",
  "ru" => "TRANS ",
  "de" => "Zur Kundenoberfläche",
  "ro" => "La interfata de client",
  "zh" => "½øÈëÓÃ»§¿ØÖÆÌ¨",
  "pl" => "Przejdz do panela klienta",
  "se" => "TRANS SVENSKA",
  "es" => "Ir al Panel del Cliente",
  "pt" => "TRANS "
  );
...
$txt_product_manager = array(
  ...
  "se" => "TRANS SVENSKA",
  "es" => "Creaci&oacute;n de paquetes de Hosting",
...
$txt_parking_popup_legend = array(
  ...
  "nl" => "Dit domein wordt de alias voor het volgende domein (domain parking):",
  "ru" => "TRANS This domain will be the alias of the following domain (domain parking):",
  "de" => "Diese Domain als Alias folgender Domain benutzen (Domain Parking):",
  "ro" => "Acest domeniu va fi alias urmatorului domeniu (domain parking):",
  "zh" => "Õâ¸öÓòÃûÊÇÏÂÁĞÓòÃûµÄ±ğÃû(ÓòÃûÍ£·Å)£º",
  "pl" => "Domena ma byæ aliasem do istniejacej domeny (parkowanie domeny):",
  "se" => "TRANS SVENSKA",
  "es" => "Este dominio ser&aacute; un alias del siguiente dominio (dominio en parking):",
...
$txt_register_custom_message_title = array(
	...
	"zh" => "Èç¹ûÄúÓĞÊ²Ã´ÌØÊâµÄÒªÇó£¬Çë¸øÎÒÃÇÁôÑÔ£º",
...
$txt_go_to_client_panel = array(
	...
	"nl" => "Ga naar client panel",
	"ru" => "TRANS",
	"de" => "Gehen Sie zur Kundenoberfläche",
	"zh" => "½øÈë¿Í»§¿ØÖÆÌ¨",
	"pl" => "Panel klienta",
	"se" => "TRANS SVENSKA",
...
$txt_list_liste_of_your_ml = array(
	...
	"nl" => "Lijst van jouw mailing lists:",
...
$txt_number_of_database = array(
	...
	"pl" => "Ilo¶æ baz danych",
	"se" => "TRANS SVENSKA",
	"es" => "N&uacute;mero de bases de datos",
	"pt" => "Número de base de dados"
	);
...
$txt_allow_to_add_domains = array(
	...
	"nl" => "Geeft toestemming om domeinen toe te voegen :",
	"ru" => "TRANS ",
	"de" => "Hinzufügen von Domains erlauben:",
	"zh" => "ÔÊĞíÌí¼ÓÓòÃû£º",
	"pl" => "Prawo do dodawania domen ",
	"se" => "TRANS SVENSKA",
	"es" => "Permitir a&ntilde;adir dominios",
	"pt" => "Permitir adicionar dominios"
...
$txt_can_have_subadmins_reseller = array(
	...
	"nl" => "Geef sub-account toevoegings rechtten (reseller) ",
	"ru" => "TRANS ",
	"de" => "Rechte zum Hinzufügen von Unterkonten vergeben (Wiederverkäufer)",
	"zh" => "ÔÊĞíÌí¼Ó×ÓÕÊ»§(×ªÊÛ)£º",
	"pl" => "Dodaj Resselera",
	"se" => "TRANS SVENSKA",
...
$txt_can_have_package_installer = array(
	...
	"de" => "Benutzung des Paket-Installers erlauben:",
...
$txt_can_have_ftp_login_for_vhosts = array(
	...
	"de" => "Hinzufügen von FTP-Logins erlauben:",
...
$txt_can_have_ssh_login_for_vhosts = array(
	...
	"nl" => "Geef toestemming om SSH logins toe te voegen:",
	"ru" => "TRANS Allow addition of SSH vhosts logins:",
	"de" => "Hinzufügen von SSH-Logins erlauben:",
	"zh" => "ÔÊĞíÌí¼ÓSSHÕË»§£º",
...
$txt_type_new_password = array(
	...
	"pl" => "Nowe has³o",
	"se" => "TRANS SVENSKA",
	"es" => "Nueva contrase&ntilde;a",
	"pt" => "Nova palavra chave"
...
$txt_retype_new_password = array(
	...
	"hu" => "Ismételje meg az új jelszót:",
	"it" => "Ripeti la nuova password:",
	"nl" => "Voer password opnieuw in: ",
	"ru" => "TRANS ",
	"de" => "Passwort wiederholen:",
	"zh" => "È·ÈÏÃÜÂë£º",
	"pl" => "Powtórz nowe has³o",
	"se" => "TRANS SVENSKA",
	"es" => "Vuelva a escribir la contrase&ntilde;a",
	"pt" => "Confirmar a palavra chave"
	);
...
$txt_total_database_number = array(
	...
	"hu" => "Adatbázisok száma:",
	"it" => "Numero totale database:",
	"nl" => "Totaal aantal databases: ",
	"ru" => "TRANS ",
	"de" => "Gesamtanzahl Datenbanken:",
	"zh" => "Êı¾İ¿âµÄ×ÜÊı",
	"pl" => "Suma baz danych ",
	"se" => "TRANS SVENSKA",
	"es" => "N&uacute;mero total de bases de datos",
...
$txt_please_create_mysql_user_to_create_database = array(
	...
	"hu" => "Hozzon létre egy MySQL felhasználót, különben nem tud adatbázist létrehozni.",
	"it" => "Per favore crea prima un utente mysql se vuoi poter creare database",
	"nl" => "Creëer eerst een MySQL gebruiker om een database aan te maken",
	"ru" => "TRANS ",
	"de" => "Bitte erstellen Sie einen MySQL-Benutzer, um eine Datenbank erstellen zu können.",
	"zh" => "Èç¹ûÒª´´½¨Ò»¸öÊı¾İ¿â,ÇëÏÈ´´½¨Ò»¸öMySQLÓÃ»§¡£",
	"pl" => "Utwórz u¿ytkownika MySQL w kolejnosci w jakiej bêd± oni tworzyæ bazy danych ",
	"se" => "TRANS SVENSKA",
	"es" => "Debe crear un usuario MYSQL para luego poder crear una base de datos",
...
$txt_wrong_user_or_password_or_timeout_expire = array(
	...
	"nl" => "Verkeerde gebruiker of password of timeout verlopen! ",
	"ru" => "TRANS ",
	...
	"se" => "TRANS SVENSKA",
	"es" => "Nombre de usuario o contrase&ntilde;a incorrecta o tiempo de ejecuci&oacute;n excedido",
	"pt" => "O utilizador ou palava chave está incorrecto, também poderá occorido a expiração do tempo de autenticação!"
);
$txt_error = array(
	"fr" => "Erreur",
	"en" => "Error",
...
$txt_fetching_admin = array(
	...
	"pl" => "Wybierz admina ",
	"se" => "TRANS SVENSKA",
	"es" => "Cargando administrador:",
	"pt" => "Procurar administrador : "
);
$txt_register_new_account = array(
	"fr" => "Ouvrir un nouveau compte",
	"en" => "Register a new account",
	"hu" => "Új hozzáférés regisztráció",
	"it" => "Registra un nuovo account",
	"nl" => "Registreer een nieuwe account ",
	"ru" => "TRANS ",
...
$txt_cmenu_add_domain = array(
	...
	"pl" => "Dodaj domenê",
	"se" => "TRANS SVENSKA",
	"es" => "A&ntilde;adir un dominio",
	"pt" => "Adicionar um dominio"
	);
$txt_cmenu_nickhandles = array(
	...
	"se" => "TRANS SVENSKA",
	"es" => "Responsables DNS",
	"pt" => "Gerir Entidades / contactos DNS"
	);
...
$txt_cmenu_nameservers = array(
	...
	"pl" => "Serwery nazw",
	"se" => "TRANS SVENSKA",
	"es" => "Servidores de nombres",
	"pt" => "Servidores de DNS"
...
$txt_cmenu_reseller = array(
	...
	"hu" => "Alhozzáférések (viszonteladó)",
	"it" => "Sotto-account (rivenditori)",
	"nl" => "sub-accounts (wederverkoper)",
	"ru" => "TRANS Sub-accounts (reseller)",
	"de" => "Unterkonten (Wiederverkäufer)",
	"zh" => "×ÓÕË»§(×ªÊÛ)",
	"pl" => "Subkonta (reseller)",
	"se" => "TRANS SVENSKA",
	"es" => "Sub-cuentas (reseller)",
	"pt" => "Contas secundárias (Revendedor)"
	);
...
$txt_mailbox_redirection_edition = array(
	...
	"nl" => "Betwerk mailbox redirections:",
	...
	"se" => "TRANS SVENSKA",
	"es" => "Edite las redirecciones de su e-mail:",
	"pt" => "Editar redireccionamentos de e-mail :"
  );
$txt_repeate_password = array(
	...
	"pl" => "Powtórz has³o :",
	"se" => "TRANS SVENSKA",
	"es" => "Repetir la contrase&ntilde;a:",
	"pt" => "Confirmar a palavra chave"
  );
...
$txt_add_a_new_user = array(
	...
	"zh" => "Ìí¼ÓĞÂÓÃ»§£º",
	"pl" => "Dodaj nowego u¿ytkownika : ",
	"se" => "TRANS SVENSKA",
	"es" => "A&ntilde;adir un nuevo usuario: ",
...
$txt_title_maillinglist_form = array(
	...
	"it" => "Mailing-lists del dominio: ",
	"nl" => "Mailling-lists van domein: ",
	"ru" => "TRANS Mailling-lists of the domain: ",
	"de" => "Domain Mailing-Listen: ",
	"zh" => "±¾ÓòµÄÓÊ¼şÁĞ±í£º",
	"pl" => "Listy mailingowe domeny : ",
	"se" => "TRANS SVENSKA",
	"es" => "Listas de correo del dominio: ",
	"pt" => "Listas de distribuição do dominio"
);
$txt_pagetop_zesubtitle = array(
	...
	"nl" => "Take the control of your domain name",
	"ru" => "TRANS Take the control of your domain name",
	"de" => "volle Kontrolle über Ihre Domains",
	"zh" => "ÇáËÉ¹ÜÀíÄúµÄÖ÷»ú",
...
$txt_root_adm_title = array(
	...
	"nl" => "Domain Technologie Control : root admin console",
	"ru" => "TRANS Domain Technologie Control : root admin console",
	"de" => "Domain Technologie Control: Administrator-Konsole",
	"zh" => "Domain Technologie Control£º¿ØÖÆÌ¨",
...
$txt_mainmenu_title_useradmin = array(
	...
	"de" => "Benutzer und Domains",
	"zh" => "ÓÃ»§¹ÜÀí",
	"pl" => "Zarz±dzanie u¿ytkownikami",
	"se" => "TRANS SVENSKA",
	"es" => "Administraci&oacute;n de usuarios",
...
$txt_add_admin_to_client = array(
	...
	"nl" => "Voeg administrator toe voor deze klant:",
	"ru" => "TRANS Add an administrator to this customer:",
	"de" => "Administrator für diesen Kunden hinzufügen:",
	"zh" => "ÎªÕâÃû¿Í»§Ìí¼ÓÒ»¸ö¹ÜÀíÔ±£º",
	"pl" => "Dodaj konto administracyjne klienta:",
	"se" => "TRANS SVENSKA",
	"es" => "A&ntilde;adir administrador para este cliente:",
	"pt" => "Adicionar um administrador para este cliente :"
	);
$txt_what = array(
	"fr" => "Libelle",
	"en" => "What",
...
$txt_bw_quota = array(
	...
	"hu" => "Sávsz. kvóta",
	"it" => "Quota BW",
	"nl" => "Bandbreedte Quota",
	"ru" => "TRANS BW Quota",
	"de" => "Bandbreite Kontingent",
	"zh" => "´ø¿íÅä¶î",
...
$txt_server_total_bp = array(
	...
	"nl" => "Totaal aantal transfers deze maand voor deze server: ",
...
$txt_subdom_limit_reach = array(
	...
	"de" => "Maximale Anzahl von Subdomains erreicht. Es können keine weiteren Subdomains mehr angelegt werden.",
	"zh" => "ÒÑ´ïµ½×ÓÓòÃûÊıÁ¿ÉÏÏŞ¡£ÎŞ·¨Ìí¼Ó£¡",
...
$txt_number_of_active_subdomains = array(
	...
	"it" => "Número sottodomini attivi:",
	"nl" => "Aantal active subdomeinen:",
	"ru" => "Number of active subdomaines:",
	"de" => "Anzahl aktiver Subdomains:",
	"zh" => "ÏÖÓĞ×ÓÓòÃûÊıÁ¿£º",
	"pl" => "Ilo¶æ aktywnych subdomen:",
	"se" => "TRANS SVENSKA",
	"es" => "N&uacute;mero de subdominios activos:",
	"pt" => "Número de subdominios activos :"
	);
$txt_maxnumber_of_ftp_account_reached = array(
	...
	"it" => "Raggiunto Número massimo di account FTP. Non puoi aggiungerne uno nuovo.",
	...
	"de" => "Maximale Anzahl von FTP-Konten erreicht. Es können keine weiteren FTP-Konten mehr angelegt werden.",
	"zh" => "ÒÑ´ïµ½FTPÕË»§ÊıÁ¿ÉÏÏŞ¡£ÎŞ·¨Ìí¼Ó£¡",
	"pl" => "Wykorzystano ju¿ limit kont FTP. Nie mogê dodaæ nowego.",
	"se" => "TRANS SVENSKA",
	"es" => "N&uacute;mero m&aacute;ximo de FTPs alcanzado. No es posible a&ntilde;adir una cuenta nueva.",
...
$txt_maxnumber_of_ssh_account_reached = array(
	...
	"de" => "Maximale Anzahl von SSH-Konten erreicht. Es können keine weiteren SSH-Konten mehr angelegt werden.",
	"zh" => "ÒÑ´ïµ½SSHÕË»§ÊıÁ¿ÉÏÏŞ¡£ÎŞ·¨Ìí¼Ó£¡",
	"pl" => "Wykorzystano ju¿ limit kont SSH. Nie mogê dodaæ nowego.",
	"es" => "N&uacute;mero m&aacute;ximo de accesos SSH alcanzado. No es posible a&ntilde;adir una cuenta nueva.",
...
$txt_number_of_active_ssh = array(
	...
	"de" => "Aktive SSH-Konten:",
	"zh" => "ÏÖÓĞSSHÕË»§ÊıÁ¿£º",
	"pl" => "Ilo¶æ aktywnych kont SSH:",
	"se" => "TRANS SVENSKA",
	"es" => "N&uacute;mero de cuentas SSH activas:",
...
$txt_number_of_active_mailbox = array(
	...
	"it" => "Número mailboxes attive:",
	"nl" => "Aantal actieve e-mail accounts :",
	"ru" => "Number of active mailboxs:",
	"de" => "Anzahl aktiver E-Mail-Konten:",
	"zh" => "ÏÖÓĞÓÊÏäÊıÁ¿£º",
	"pl" => "Ilo¶æ aktywnych kont pocztowych:",
	"se" => "TRANS SVENSKA",
	"es" => "N&uacute;mero de cuentas de correo activas:",
	"pt" => "Número de contas de correio activas :"
	);
$txt_maximum_mailbox_reach = array(
	...
	"it" => "Raggiunto Número massimo mailboxes. Non puoi aggiungerne una nuova.",
	...
	"de" => "Maximale Anzahl von E-Mail-Konten erreicht. Es können keine weiteren E-Mail-Konten mehr angelegt werden.",
	"zh" => "ÒÑ´ïµ½ÓÊÏäÊıÁ¿ÉÏÏŞ¡£ÎŞ·¨Ìí¼Ó£¡",
	"pl" => "Wykorzystano ju¿ limit kont e-mail. Nie mogê dodaæ nowego konta.",
	"se" => "TRANS SVENSKA",
	"es" => "N&uacute;mero m&aacute;ximo de cuentas de correo alcanzado. No es posible a&ntilde;adir una cuenta nueva.",
	"pt" => "Não é possivel adicionar conta, numero maximo alcançado."
	);
$txt_virtual_admin_list = array(
	...
	"nl" => "Beheerderslijst",
	"ru" => "óĞÉÓÏË ÁÄÍÉÎÉÓÔÒÁÔÏÒÏ×",
	"de" => "Benutzer und Domains",
	"zh" => "¹ÜÀíÔ±ÁĞ±í",
	"pl" => "Lista Administratorów",
	"se" => "TRANS SVENSKA",
...
$txt_add_user_title = array(
	...
	"de" => "virtuellen Administrator hinzufügen",
	"zh" => "Ìí¼ÓĞéÄâÖ÷»ú¹ÜÀíÔ±",
	"pl" => "Dodaj wirtualnego Administratora",
	"se" => "TRANS SVENSKA",
	"es" => "A&ntilde;adir un administrador virtual",
	"pt" => "Adicionar um administrador virtual"
	);
$txt_generate_buttons_title = array(
	...
	"ru" => "÷ÙĞÏÌÎÅÎÉÅ ÇÅÎÅÒÁÃÉÉ ËÏÎÆÉÇÕÒÁÃÉÏÎÎÙÊ ÆÁÊÌÏ×",
	"de" => "Konfigurationsdateien erstellen",
	"zh" => "Éú³ÉÅäÖÃÎÄ¼ş",
	"pl" => "Uruchom generator plików konfiguracji",
	"se" => "TRANS SVENSKA",
	"es" => "Lanzando la generaci&oacute;n de archivos de configuraci&oacute;n.",
	"pt" => "A lançar a geração dos ficheiros de configuração"
	);
$txt_general_virtual_admin_edition = array(
	...
	"de" => "virtuellen Administrator <i>\"$adm_login\"</i> konfigurieren",
	"zh" => "ĞéÄâÖ÷»ú¹ÜÀíÔ±ÅäÖÃ<i>\"$adm_login\"</i>",
	...
	"es" => "Configuraci&oacute;n del administrador virtual <i>\"$adm_login\"</i>",
	"pt" => "Configuração do administrador virtual <i>\"$adm_login\"</i>"
	);
$txt_domains_configuration_title = array(
	...
	"zh" => "ÅäÖÃ<i>\"$adm_login\"</i>µÄÓò",
	"pl" => "Konfiguracja domen nale¿±cych do <i>\"$adm_login\"</i>",
	"se" => "TRANS SVENSKA",
	"es" => "Configuraci&oacute;n para cada dominio de <i>\"$adm_login\"</i>",
	"pt" => "Configuraçaõ para cada dominio do  <i>\"$adm_login\"</i>"
	);
$txt_admlist_sort_by_legend = array(
	...
	"pl" => "Sortuj wg:",
	"se" => "TRANS SVENSKA",
	"es" => "Mostrar y ordenar por:",
	"pt" => "Listar ordenados por:"
	);
...
$txt_admlist_new_admin = array(
	...
	"zh" => "ĞÂµÄĞéÄâÖ÷»ú¹ÜÀíÔ±",
	"pl" => "Nowy wirtualny Administrator",
	"se" => "TRANS SVENSKA",
	"es" => "Nuevo administrador virtual",
...
$txt_use_images_menu = array(
	...
	"nl" => "Gebruik afbeeldingen menu",
	"ru" => "TRANSUse image menu",
	"de" => "Verwenden Sie das grafische Menü",
	"zh" => "Ê¹ÓÃÍ¼ĞÎ²Ëµ¥",
	"pl" => "Menu graficzne",
	"se" => "Bild menu",
...
$txt_del_user_confirm = array(
	...
	"zh" => "ÄãÈ·¶¨ÒªÉ¾³ıÕâ¸öÓÃ»§Âğ£¿ÕâÏî²Ù×÷½«É¾³ı¸ÃÓÃ»§ËùÓĞµÄÓòÃû£¬ÎÄ¼ş£¬Êı¾İ¿âµÈµÈ£¡£¡£¡",
...
$txt_del_user_domain_confirm = array(
	...
	"zh" => "ÄãÈ·¶¨ÒªÉ¾³ıÕâ¸öÓòÃûÂğ£¿ÕâÏî²Ù×÷½«É¾³ıÕâ¸öÓòÃûÏÂµÄËùÓĞÎÄ¼ş£¡£¡£¡",
...
$txt_confirurate_your_domain_name = array(
	...
	"zh" => "ÅäÖÃÄúµÄÓòÃû£º",
    "pl" => "Konfiguracja twojej domeny :",
    "se" => "TRANS SVENSKA",
	"es" => "Configure su nombre de dominio",
	"pt" => "Configurar o seu dominio"
	);
// MY ACCOUNT STRINGS
$txt_transfer_du = array(
	...
	"de" => "Transfer und Disk-Nutzung:",
	"zh" => "Á÷Á¿Óë´ÅÅÌÊ¹ÓÃÂÊ£º",
	"pl" => "Transfer i u¿ycie dysku :",
	"se" => "TRANS SVENSKA",
	"es" => "Transferencia y uso de disco:",
	"pt" => "Tráfego e utilização de disco"
	);
$txt_transfer_this_month = array(
	...
	"de" => "Transfer diesen Monat:",
	"zh" => "±¾ÔÂÁ÷Á¿£º",
	"pl" => "Transfer w tym m-cu :",
	"se" => "TRANS SVENSKA",
	"es" => "Transferencia mes actual:",
...
$txt_transfer_per_month = array(
	...
	"hu" => "TRANS ",
	"it" => "TRANS ",
	"nl" => "Transfer per maand ",
	"ru" => "TRANS ",
	"de" => "Transfer pro Monat",
	"zh" => "Ã¿ÔÂ",
   	"pl" => "Transfer na miesi±c",
   	"se" => "TRANS SVENSKA",
	"es" => "Transferencia por mes",
	"pt" => "TRANS "
	);
$txt_transfer = array(
	"fr" => "Transfert",
...
$txt_your_hosting_account = array(
	...
	"de" => "Ihr Hosting-Konto:",
	"zh" => "ÄúµÄÕË»§£º",
    "pl" => "Twoje konto hostingowe:",
    "se" => "TRANS SVENSKA",
	"es" => "Su cuenta de hosting:",
	"pt" => "Sua conta de alojamento :"
	);
...
$txt_allowed_data_transfer = array(
	...
	"de" => "Zulässige Bandbreite pro Monat",
	"zh" => "Ã¿ÔÂ×î´óÊı¾İ´«ÊäÁ¿",
    "pl" => "Miesiêczny transfer",
    "se" => "TRANS SVENSKA",
	"es" => "Ancho de Banda permitido por mes",
    "pt" => "Tráfego permitido por mês"
);
$txt_allowed_data_transferMB = array(
	...
	"de" => "Zulässige Bandbreite pro Monat (MB):",
	"zh" => "Ã¿ÔÂ×î´óÊı¾İ´«ÊäÁ¿(GB)£º",
    "pl" => "Miesiêczny transfer (MB) :",
    "se" => "TRANS SVENSKA",
	"es" => "Ancho de Banda permitido por mes (MB):",
	"pt" => "Tráfego permitido por mês (MB)"
);
...
$txt_remaining_money = array(
	...
	"de" => "Verbleibendes Guthaben auf meinem Konto:",
	"zh" => "ÎÒµÄÕÊ»§Óà¶î£º",
    "pl" => "Pozosta³o na koncie :",
    "se" => "TRANS SVENSKA",
...
$txt_refund_my_account = array(
	...
	"de" => "Guthaben auf mein Konto übertragen:",
	"zh" => "ÎÒµÄÍË¿î£º",
    "pl" => "Zasil swoje konto :",
    "se" => "TRANS SVENSKA",
	"es" => "Acreditar dinero a mi cuenta:",
...
$txt_please_tell_if_info_not_ok = array(
	...
	"zh" => "Çë¸æËßÎÒÃÇÏÂÁĞĞÅÏ¢ÊÇ·ñÕıÈ·£º",
    "pl" => "Proszê powiadomiæ nas gdy dane bêd± niepoprawne :",
    "se" => "TRANS SVENSKA",
	"es" => "Por favor d&iacute;ganos si la informaci&oacute;n siguiente no es correcta:",
...
$txt_my_account_global_stats_title = array(
	...
	"de" => "Gesamtübersicht über mein Konto",
	"zh" => "ÕÊ»§Í³¼ÆĞÅÏ¢",
...
$txt_stats_http_subdom = array(
	...
	"nl" => "Gedetaileerde webalizer HTTP statistieken van jouw subdomains:",
	"ru" => "TRANS Detailed webalizer HTTP statistics of your subdomains:",
	"de" => "Detaillierte Webalizer Statistiken (HTTP) Ihrer Subdomains:",
	"zh" => "×ÓÓòÃûµÄwebalizerÏêÏ¸Í³¼Æ½á¹û£º",
    "pl" => "Szczegó³owe statystyki Webalizera twoich subdomen :",
    "se" => "TRANS SVENSKA",
	"es" => "Estad&iacute;sticas HTTP detalladas de webalizer sobre sus subdominios:",
...
domaine soit hébergé ailleurs.<br>
Le paramêtre MX dit ou se trouve le serveur de
courrier (celui qui récupère et stocke tous vos
...
célra használni.",
	...
	"it" => "Attenzione ! Settando in maniera sbagliata i 
valori nei seguenti campi potrebbe causare lo stop dei servizi (web o mail).<br>
Inserendo qualcosa di diverso da \"default\" nei campi DNS significa che 
tu vuoi che il tuo sito sia hostato da qualche parte.<br>
Il parametro MX indica l'indirizzo del mail server
(quello che salva tutte le email quando qualcuno ti invia un 
messaggio). Il valore \"default\" significa che vuoi utilizzare il 
server corrente.",
...
your a message). The value \"default\" means that
you want to use the current server.",
	"de" => "Achtung! Wenn Sie in den folgenden Feldern falsche Angaben machen, kann dies dazu führen, dass Ihre Webseiten oder E-Mail-Adressen nicht mehr erreichbar sind.<br>
Eine andere Angabe als \"default\" im DNS Feld bedeutet, dass Ihre Seite anderswo gehostet wird.
Die MX-Parameter geben die Adresse des Mailservers an (auf dem Ihre E-Mails gespeichert werden, wenn Ihnen jemand eine Nachricht schickt).
Die Angabe \"default\" bedeutet, dass Sie diesen Server nutzen wollen.",
	"zh" => "µ±ĞÄ£¡Ç§Íò²»Òª½«ÏÂÁĞÑ¡ÏîÉèÖÃÎª´íÎóµÄÖµ£¬·ñÔò£¬ÄúµÄÄ³Ğ©·şÎñ¿ÉÄÜ»áÍ£Ö¹(ÀıÈç:ÓÊ¼ş·şÎñ»òwww·şÎñ)<br>
Èç¹ûÄúÔÚDNSÖĞÊäÈë\"default\"ÒÔÍâµÄÖµ£¬Õâ½«ÒâÎ¶×ÅÄúÏ£ÍûÊ¹ÓÃÆäËü·şÎñÆ÷À´½âÎöÄúµÄÓòÃû<br>
MX²ÎÊıÉùÃ÷ÁËÄúµÄÓÊ¼ş·şÎñÆ÷µÄµØÖ·(µ±ÓĞÈË¸øÄú·¢ËÍÓÊ¼şÊ±Ëü½«´¢´æËùÓĞÄúÊÕµ½µÄÓÊ¼ş)<br>
Èç¹ûÄú±£ÁôÊäÈë¿òÖĞµÄ\"default\"½«ÒâÎ¶×ÅÄúÏ£ÍûÊ¹ÓÃµ±Ç°µÄ·şÎñÆ÷",
	"pl" => "Sprawd¼ dane ! Z³e dane spowoduj± niepoprawne dzia³anie twojego serwera (web i mail).<br>Je¶li nie jeste¶ pewien, pozostaw <b>\"default\"</b> w polu DNS i MX.<br>Wpis <b>\"default\"</b> wskazuje na ten serwer.",
	"se" => "TRANS SVENSKA",
	"es" => "¡Atención! La configuraci&oacute;n incorrecta 
de las siguientes opciones puede hacer parar 
sus servicios (web o mail).<br>
Poniendo algo distinto a &quot;default&quot; en las opciones de
DNS significa que Ud. desea alojar su sitio en otra parte.<br>
...
$txt_primari_dns_ip = array(
	...
	"de" => "IP-Adresse des primären DNS-Servers:",
	"zh" => "Ö÷DNS·şÎñÆ÷µÄIPµØÖ·£º",
	"pl" => "Adres IP serwera Primary DNS :",
	"se" => "TRANS SVENSKA",
	"es" => "Direcci&oacute;n IP del servidor DNS primario:",
...
$txt_other_dns_ip = array(
	...
	"zh" => "ÆäËûDNS·şÎñÆ÷£º",
	"pl" => "Serwery zapasowe DNS :",
	"se" => "TRANS SVENSKA",
	"es" => "Otros servidores DNS:",
...
$txt_primary_mx_server = array(
	...
	"se" => "TRANS SVENSKA",
	"es" => "Direcci&oacute;n MX primaria:",
...
$txt_draw_tatabase_your_list = array(
	...
	"pl" => "Spis twoich baz danych :",
	"se" => "TRANS SVENSKA",
	"es" => "Lista de sus bases de datos:",
...
$txt_title_geninfo_form = array(
	...
	"se" => "TRANS SVENSKA",
	"es" => "Informaci&oacute;n general de ",
...
$txt_subdom_txtrec = array(
	...
	"nl" => "TXT veld van subdomain: ",
	"ru" => "TRANS TXT field of the subdomain: ",
	"de" => "TXT-Feld der Subdomain: ",
	"zh" => "ÔÚÕâÀïÊäÈë×ÓÓòÃû£º",
...
$txt_subdom_ip = array(
	...
	"nl" => "IP addres of CNAME: ",
	"ru" => "TRANS IP address or CNAME: ",
	"de" => "IP-Adresse oder CNAME: ",
	"zh" => "IPµØÖ·»òCNAME: ",
...
che un sottodominio punti lì. Prima, inserisci login e passord qui: ",
	"nl" => "het is mogelijk wanneer nodig om het het ip address remote in te stellen,
Bijvoorbeeld wanneeer je een thuis verbinding met een dynamisch adress hebt en je een subdomein ernaar wilt vewijzen.
Vul eerst een login en password hier in:",
...
subdomain to point to it. First, enter login and password here: ",
	"de" => " Wenn benötigt kann die IP-Adresse der Suddomain von außen festgelegt werden, z.B. wenn Sie eine dynamische IP-Adresse haben und möchten, dass die Subdomain darauf zugreift. Dazu geben Sie Login und Passwort an: ",
	"zh" => "Èç¹ûĞèÒªµÄ»°£¬Äú¿ÉÒÔÉèÖÃÄúµÄ×ÓÓòÃûÖ¸ÏòÒ»¸ö·Ç±¾µØIP¡£ÀıÈç£¬Èç¹ûÄúÏ£ÍûÕâ¸ö×ÓÓòÃûÖ¸Ïò¼ÒÀïµÄÒ»¸ö¶¯Ì¬IPµØÖ·µÄ»°£¬ÇëÔÚÕâÀïÊäÈëµÇÂ¼ÃûºÍÃÜÂë£º",
	"pl" => "Je¿eli to mo¿liwe, wpisz swój adres domowy IP. Je¶li masz adres dynamiczny, np. z Neostrady, wpisz login i has³o tutaj : ",
	"se" => "TRANS SVENSKA",
	"es" => "Si es necesario, es posible indicar la IP del subdominio remotamente, por ejemplo, si tiene una conexi&oacute;n con IP din&aacute;mica y quiere que un
subdominio apunte a &eacute;sta. Primero, introduce aqu&iacute; el usuario y la contrase&ntilde;a:",
...
$txt_subdom_dynip_pass = array(
	...
	"nl" => "Dynamisch IP update password: ",
	"ru" => "TRANS Dynamic IP update password: ",
	"de" => "Dynamic-IP Passwort: ",
	"zh" => "¶¯Ì¬IP¸üĞÂÃÜÂë£º",
	"pl" => "Has³o do dynamicznej aktualizacji adresu IP : ",
	"se" => "TRANS SVENSKA",
	"es" => "Contrase&ntilde;a IP din&aacute;mica: ",
...
$txt_subdom_register_global = array(
	...
	"nl" => "Gebruik register_globals=1:",
	"ru" => "TRANS Use register_globals=1:",
	"de" => "Benutze register_globals=1:",
	"zh" => "¿ªÆôregister_globals£º",
...
$txt_subdom_generate_vhost = array(
	...
	"nl" => "Genereer een vhostingang voor dit subdomain:",
	"ru" => "ĞŸÑ€Ğ¾Ğ¸Ğ·Ğ²ĞµĞ´Ğ¸Ñ‚Ğµ Ğ²Ñ…Ğ¾Ğ´ vhost Ğ´Ğ»Ñ ÑÑ‚Ğ¾Ğ³Ğ¾ subdomain:",
	"de" => "Erzeugen Sie einen VHost-Eintrag für diese Subdomain:",
	"zh" => "Éú³ÉÕâ¸ö×ÓÓòÃûµÄĞéÄâÖ÷»úÈë¿Ú£º",
	"pl" => "Wygeneruj virtualne hosty dla swojej domeny(dodaj subdowmeny):",
	"se" => "TRANS SVENSKA",
	"es" => "Generar una entrada vhost para este subdominio:",
...
$txt_subdom_nameserver_for = array(
	"fr" => "Ce subdomain est une entrÃ©e du nameserver (NS)<br>pour le subdomain suivant  ",
	...
	"ru" => "Ğ­Ñ‚Ğ¸Ğ¼ subdomain Ğ±ÑƒĞ´ĞµÑ‚ Ğ²Ñ…Ğ¾Ğ´ nameserver (ns)<br>Ğ´Ğ»Ñ following subdomain: ",
	"de" => "Diese Subdomain ist ein Nameserver- (NS-)<br>Eintrag für die folgende Subdomain: ",
	"zh" => "Õâ¸ö×ÓÓòÃûÊÇÏÂÁĞ×ÓÓòÃûµÄÈë¿Ú£º",
	...
	"pt" => "Este subdomain Ã© uma entrada do nameserver (NS)<br>para o seguinte subdomain: ",
);

$txt_subdom_srv_record = array(
	"fr" => "Ce subdomain est une entrÃ©e du service (SRV)<br>pour le port suivant  ",
	...
	"it" => "Questo subdomain Ã¨ un'entrata del service (SRV)<br>per il seguente port: ",
	"nl" => "Dit subdomain is een service(srv)<br>ingang voor volgende port: ",
	"ru" => "Ğ­Ñ‚Ğ¸Ğ¼ subdomain Ğ±ÑƒĞ´ĞµÑ‚ Ğ²Ñ…Ğ¾Ğ´ service (srv)<br>Ğ´Ğ»Ñ following port: ",
	"de" => "Diese Subdomain ist ein Service- (SRV-)<br>Eintrag für den folgenden Port: ",
	"zh" => "Õâ¸ö×ÓÓòÃûÊÇÏÂÁĞ×ÓÓòÃûµÄÈë¿Ú£º",
	...
	"pt" => "Este subdomain Ã© uma entrada do service (SRV)<br>para o seguinte port: ",
);
...
un laps de temps entre 30 minutes et 2 heures. S'il vous plaît,
ne mettez pas en place une mise a jour plus fréquement que 10 minutes,
de toutes facons DTC ne mettra pas a jour plus rapidement (conseil:
...
altrimenti DTC non genererà un file di zona dominio più
spesso che ogni 10 minuti (ricorda: configura il tuo server con
l'orologio di rete e fai questo al 9,19,29,39,49 e 59 di ogni ora).",
	"nl" => "Voeg nu simpelweg het volgende script toe aan jouw Unix system contab (lynx-ssl is nodig). Aanbevolen tijd is tussen 30 minuten en 2 uur",
...
network clock and do it at 9,19,29,39,49 and 59 of each hours).",
	"de" => "Fügen Sie einfach folgendes Script zu Ihrer Unix-Crontab hinzu (lynx-ssl ist erforderlich). Die empfohlene Zeit ist alle 30 Minuten bis 2 Stunden. Bitte führen Sie dieses Skript nicht öfter als alle 10 Minuten durch, denn DTC erzeugt grundsätzlich die Domain-Zonendateien nur alle 10 Minuten (Tipp: synchronisieren Sie Ihren Server mit der Netzwerk-Uhrzeit und führen Sie den Vorgang jeweils zur Minute 9,19,29,39,49 und 59 jeder Stunde durch).",
	"zh" => "È»ºó½«ÏÂÁĞ³ÌĞò¼ÓÈëµ½crontabÖĞ(ĞèÒªlynx-sslÖ§³Ö)¡£ÍÆ¼öµÄÊ±¼äÊÇ½éÓÚ£³£°·ÖÖÓµ½£²Ğ¡Ê±¡£Çë²»Òª¹ıÓÚÆµ·±(ÀıÈçÊ®·ÖÖÓÒ»´Î)£¬·ñÔòDTC½«²»Óè´¦Àí¡£(½¨Òé£ºÔÚÄúµÄ·şÎñÆ÷ÅäÖÃNTP(ÍøÂçÊ±¼äĞ­Òé)²¢ÇÒÔÚÃ¿Ğ¡Ê±µÄ9¡¢19¡¢29¡¢39¡¢49¡¢59·Ö¸÷ÔËĞĞÒ»´Î)¡£",
	"pl" => "Mo¿esz dodaæ skrypty do systemu crontab (lynx-ssl wymagany). Zalecane czasy zawieraj± siê miêdzy 30 minut a 2 godziny. Nie ustawiaj czasu na x0 minut, DTC nie bêdzie generowa³ twoich skryptów autokonfiguracji (mo¿esz ustawiæ np. 9,19,29,39,49 i 59 ka¿dej godziny).",
	"se" => "TRANS SVENSKA",
	"es" => "Luego simplemente a&ntilde;ada el siguiente script al crontab
de su sistema Unix (lynx-ssl es necesario). El tiempo recomendado est&aacute; entre
30 minutos y 2 horas. Por favor, no haga esto con frecuencias menores a 
10 minutos, de todos modos DTC no generar&aacute; un fichero de zona de dominios
cada menos de 10 minutos (consejo: configure su servidor con un reloj en red y
haga esto en los minutos 9,19,29,39,49 y 59 de cada hora).",
...
$txt_subdom_windowsusers = array(
	...
	"nl" => "Windows gebruikers kunnen via de volgende url hun query automatiseren:",
	"ru" => "TRANS Windows user can easily automate the query of the following URL:",
	"de" => "Windows-Benutzer können eine Anfrage an der folgenden URL durchführen:",
	"zh" => "WindowsÓÃ»§¿ÉÒÔ¶¨Ê±ÇëÇóÏÂÁĞURL£º",
	"pl" => "U¿ytkownik Windows mo¿e ³atwo pobieraæ dane z adresu URL:",
	"se" => "TRANS SVENSKA",
	"es" => "Los usuarios de Windows pueden utilizar el programador de tareas para efectuar la siguiente consulta:",
...
$txt_mail_liste_of_your_box = array(
	...
	"de" => "Liste Ihrer E-Mail-Konten",
	"zh" => "ÓÊÏäÁĞ±í£º",
	"pl" => "Spis twoich skrzynek pocztowych : ",
	"se" => "TRANS SVENSKA",
	"es" => "Listado de sus cuentas de correo",
...
$txt_mail_check_to_send_bounce_msg = array(
	...
	"nl" => "Vink aan om een bounce bericht te sturen: ",
	"ru" => "TRANS Check to send a bounce message: ",
	"de" => "automatische Antwort aktivieren: ",
	"zh" => "¼ì²éÊÇ·ñ·¢ËÍÒ»·âµ¯»ØÓÊ¼ş£º",
...
$txt_mail_bounce_msg_content = array(
	...
	"nl" => "Inhoud bounce bericht: ",
	"ru" => "TRANS Bounce message content: ",
	"de" => "Inhalt der automatischen Antwort: ",
	"zh" => "µ¯»ØÓÊ¼şµÄÄÚÈİ£º",
...
$txt_mail_quota_files = array(
	...
	"nl" => "Quota max bestanden: ",
	"ru" => "TRANS quota max files: ",
	"de" => "Mailbox Quota max. Dateien: ",
...
$txt_mail_edit = array(
	...
	"de" => "Konfiguration des E-Mail-Kontos",
	"zh" => "ÓÊÏäÅäÖÃ£º",
	"pl" => "Konfiguracja skrzynki pocztowej: ",
	"se" => "TRANS SVENSKA",
	"es" => "Configuraci&oacute;n de la cuenta de correo:",
...
$txt_ftp_account_list = array(
	...
	"de" => "Liste Ihrer FTP-Konten:",
	"zh" => "ÄúµÄFTPÕÊ»§ÁĞ±í£º",
	"pl" => "Spis twoich kont FTP : ",
	"se" => "TRANS SVENSKA",
	"es" => "Listado de sus cuentas FTP:",
...
$txt_ftp_account_edit = array(
	...
	"de" => "Konfiguration des FTP-Kontos",
	"zh" => "FTPÕÊ»§ÅäÖÃ£º",
...
$txt_ssh_account_list = array(
	...
	"ru" => "óĞÉÓÏË ×ÁÛÉÈ æôğ ÁËËÁÕÎÔÏ×:",
	"de" => "Liste Ihrer SSH-Konten:",
	"zh" => "ÄúµÄSSHÕÊ»§ÁĞ±í£º",
	"pl" => "Spis twoich kont SSH : ",
	"se" => "TRANS SVENSKA",
	"es" => "Lista de sus cuentas SSH:",
...
$txt_ssh_account_edit = array(
	...
	"ru" => "ëÏÎÆÉÇÕÒÁÃÉÑ æôğ-ÁËËÁÕÎÔÁ:",
	"de" => "Konfiguration des SSH-Kontos",
	"zh" => "SSHÕÊ»§ÅäÖÃ£º",
	"pl" => "Konfiguracja konta SSH : ",
	"se" => "TRANS SVENSKA",
	"es" => "Edici&oacute;n de cuenta SSH",
