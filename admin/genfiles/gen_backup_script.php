...
//			$restor_net .= "chown -R nobody:$conf_nobody_group_id $webname\n";
	...
	$backup_net .= "fi\n";
	$backup_net .= "if [ -e $conf_generated_file_path/dtcdb_passwd ] ; then\n";
	$backup_net .= "	ncftpput -f $conf_generated_file_path/ncftpput_login.cfg -V -T tmp. $ncftp_mode $conf_ftp_backup_dest_folder $conf_generated_file_path/dtcdb_passwd\n";
	$backup_net .= "fi\n";
	$restor_net .= "echo \"Getting file dtcdb_passwd\"\n";
	$restor_net .= "rm $conf_generated_file_path/dtcdb_passwd\n";
	$restor_net .= "ncftpget -f $conf_generated_file_path/ncftpput_login.cfg $ncftp_mode $conf_generated_file_path $conf_ftp_backup_dest_folder/dtcdb_passwd\n";
