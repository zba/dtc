...
$txt_cfg_main_software_config =array(
	...
	"ru" => "Конфигурация центральной системы",
...
$txt_cfg_use_nated_vhost = array(
	...
	"zh" => "тз╬жсРмЬж╥п╢обкЫспapache vhosts (NAT)",
...
$txt_cfg_nated_vhost_ip = array(
	...
	"de" => "Locale IP Adresse die fЭr den VHost verwendet werden soll(NAT)",
	"zh" => "vhostуЩтзй╧сц╣д╬жсРмЬж╥NAT",
...
$txt_cfg_full_hostname = array(
	...
	"ru" => "Полное имя хоста с административной панелью DTC",
	"de" => "VollstДndiger Rechnername des DTC",
	"zh" => "DTC╧эюМцФ╟Е╣дмЬу╬х╚цШ",
...
$txt_cfg_main_site_ip =array(
	...
	"ru" => "Основной адрес сайта",
	"de" => "Haupt IP Adresse:",
	"zh" => "жВр╙ip╣ьж╥╣д╥ЧнЯфВ",
	"es" => "IP principal del sitio:");

$txt_cfg_site_addrs =array(
	"fr" => "Adresses IP de votre machine (sИparИ par des \"|\") :",
...
$txt_cfg_name_zonefileconf_title =array(
	...
	"ru" => "Конфигурация зон ДНС",
	"de" => "Bind Zonendateien Konfiguration",
	"zh" => "Named zonefilesеДжц",
...
$txt_cfg_main_mx_addr =array(
	...
	"ru" => "Адрес Вашего основного MX-сервера",
	"de" => "Adresse des Haupt Mailservers:",
	"zh" => "дЗ╣джВр╙MX╥ЧнЯфВ╣д╣ьж╥",
...
$txt_cfg_mail_addr_webmaster =array(
	...
	"ru" => "Почтовый адрес Вашего вебмастера:",
	"de" => "E-Mailadresse des webmasters",
	"zh" => "дЗ╣дмЬ╧э╣д╣ГвссйоД╣ьж╥",
...
$txt_cfg_primary_dns_server_addr =array(
	...
	"ru" => "Первичный адрес ДНС :",
	"de" => "Adresse des primДren DNS:",
	"zh" => "╣зр╩╦ЖсРцШ╥ЧнЯфВ╣ьж╥",
...
$txt_cfg_secondary_dns_server_addr =array(
	...
	"ru" => "Вторичный адрес ДНС :",
	"de" => "Adresse des sekundДren DNS:",
	"zh" => "╣з╤Ч╦ЖсРцШ╥ЧнЯфВ╣ьж╥",
...
$txt_cfg_slave_dns_ip =array(
	...
	"ru" => "Адрес подчиненного ДНС-сервера:",
...
$txt_cfg_dtc_shared_folder =array(
	...
	"ru" => "Файловый путь к вашей DTC \"общей\" директории:",
	"de" => "Pfad des DTC \"shared\" Verzeichnisses:",
	"zh" => "дЗ╣дDTC╣дб╥╬╤\"shared\"д©б╪:",
...
$txt_cfg_new_account_defaultpath =array(
	...
	"ru" => "Директория новой учетной записи по умолчанию:",
	"de" => "Standard Verzeichnis fЭr neue Accounts:",
	"zh" => "дЗ╣дт╓иХпбуй╩╖д©б╪",
	"es" => "Directorio por defecto de tu nueva cuenta:");

$txt_cfg_generated_file_path =array(
	"fr" => "Chemin ou DTC va Йtre restreint pour gИnИrer ses fichiers
de configuration pour les daemons.
Chacun des chemin ci-aprХs (qmail, apache et named) seront concatИnИs Ю
celui-ci :",
...
van z'n configuratie bestanden voor de daemons.",
	"ru" => "Путь где DTC позволит генерировать эти конфигурационные
файлы для демонов. Каждый из следующих (qmail, apache and named) путей будет сопоставим с
этим:",
	"de" => "Pfad wo DTC seine Konfigurationsdatein fЭr alle Daemons
ablegen soll.",
	"zh" => "иХжцDTC╫╚п╢обфДнд╪Ч(qmail, apache and named)",
...
$txt_cfg_phplib2_path =array(
	...
	"ru" => "Путь к дополнительным библиотекам PHP:",
	"de" => "ZusДtzliche PHP Bibliotheken:",
	"zh" => "Php╣д╦╫╪снд╪Ч╪пб╥╬╤:",
...
$txt_cfg_named_slave_file =array(
	...
	"ru" => "Подчиненный файл ДНС:",
	"de" => "Slave Binddatei:",
	"zh" => "Named╠╦сц╥ЧнЯфВнд╪Ч:",
...
$txt_cfg_named_main_zonefile =array(
	...
	"ru" => "Папка файлов центральных зон для сервера ДНС:",
	"de" => "Bind Masterzonen Verzeichnis",
	"zh" => "NamedжВр╙zonefilesнд╪Ч╪п:",
...
$txt_cfg_named_cache_slave_zonefile =array(
	...
	"ru" => "Папка для кэширования файлов зон:",
	"de" => "Bind Slavezonen Verzeichnis",
	"zh" => "Named╠╦сц(╦╢жф)zonefilesнд╪Ч╪п:",
...
$txt_cfg_backup_webalizer_title =array(
	...
	"ru" => "Резервные и анализирующие имена файлов",
	"de" => "Sicherungs und Webalizer Dateinamen",
	"zh" => "╠╦сц╨мWebalizerнд╪ЧцШвж",
...
$txt_cfg_backup_script_filename =array(
	...
	"ru" => "Скрипт резервного копирования (Bash):",
	"de" => "Sicherungs-script:",
	"zh" => "╠╦сц╨мbashЁлпРнд╪ЧцШвж:",
...
$txt_cfg_backup_destination_folder =array(
	...
	"ru" => "Директория создания резервных копий:",
...
$txt_cfg_webalizer_script_filename =array(
	...
	"ru" => "Скрипты(Bash) Webalizer",
	"de" => "Webalizer bash-script:",
	"zh" => "Webalizer bashЁлпРцШвж:",
