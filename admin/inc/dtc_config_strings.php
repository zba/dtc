...
$txt_cfg_allow_following_servers_to_list = array(
	...
	"zh" => "ÔÊĞíÏÂÁĞ·şÎñÆ÷Á¬½ÓºÍÅÅÁĞÓòÃû±í£º",
...
$txt_cfg_make_request_to_server_for_update = array(
	...
	"zh" => "µ±ÓòÃûÌí¼Ó»òÉ¾³ıÊ±Í¨ÖªÏÂÁĞ·şÎñÆ÷£º",
...
$txt_cfg_make_request_to_server_mx_update = array(
	...
	"zh" => "å‘Šè¯‰ä»¥ä¸‹æœåŠ¡å™¨ç”µå­é‚®ä»¶å¢åŠ æˆ–è¢«å»é™¤",
...
$txt_cfg_use_nated_vhost = array(
	...
	"zh" => "ÔÚ¾ÖÓòÍøÖ·Ğ´ÏÂËùÓĞapache vhosts (NAT)",
...
$txt_cfg_secondary_dns_server_addr =array(
	...
	"ru" => "÷ÔÏÒÉŞÎÙÊ ÁÄÒÅÓ äîó :",
	"de" => "Adresse des sekundären DNS Servers:",
	"zh" => "µÚ¶ş¸öÓòÃû·şÎñÆ÷µØÖ·",
...
$txt_cfg_phplib_path = array(
	...
	"zh" => "TRANS LPhpµÄÎÄ¼ş¼Ğ open_basedir (±»\":\"Çø·Ö, reset on each dtc install):",
...
$txt_cfg_phplib2_path =array(
	...
	"zh" => "PhpµÄ¸½¼ÓÎÄ¼ş¼ĞÂ·¾¶ open_basedir (keeped uppon reinstallation):",
...
$txt_cfg_named_cache_slave_zonefile =array(
	...
	"zh" => "Named±¸ÓÃ(¸´ÖÆ)zonefilesÎÄ¼ş¼Ğ:",
