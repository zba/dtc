<?php
	...
	* @version  $Id: dtc_config_strings.php,v 1.55 2007/02/09 19:59:07 thomas Exp $
...
vuoto se non si hanno server DNS di backup):",
        ...
        "de" => "TRANS List here your backup MX servers separated by &quot;|&quot; (pipe)<br>
                (leave blank if you don't have backup MX server):",
        "zh" => "ÁÐ³öËùÓÐµÄ±¸ÓÃMX·þÎñÆ÷(ÓÃ\"|\"¸ô¿ª)<br>
                (Èç¹ûÃ»ÓÐÔòÁô¿Õ)£º",
...
"zh" => "Á¬½Óµ½Tucows·þÎñÆ÷µÄ¼ÓÃÜ·½Ê½£º",
...
"ru" => "TRANS Domain name registry API configuraiton",
"de" => "TRANS Domain name registry API configuraiton",
"zh" => "Ê¹ÓÃÕæÊµ·þÎñÆ÷(¶ø²»ÊÇ²âÊÔ·þÎñÆ÷)£º",
...
"en" => "PayPal test account email (sandbox):",
	...
	"zh" => "±´±¦²âÊÔ·þÎñÆ÷ÕËºÅ(ÓÊ¼þµØÖ·ÐÎÊ½)£º",
...
$txt_cfg_allow_following_servers_to_list = array(
	...
	"zh" => "ÔÊÐíÏÂÁÐ·þÎñÆ÷±¸·Ý±¾·þÎñÆ÷µÄÓòÃû£º",
...
$txt_cfg_make_request_to_server_for_update = array(
	...
	"zh" => "µ±Ìí¼Ó»òÉ¾³ýÒ»¸öÓòÃûÊ±Í¨ÖªÏÂÁÐ·þÎñÆ÷£º",
...
$txt_cfg_make_request_to_server_mx_update = array(
	...
	"zh" => "µ±Ìí¼Ó»òÉ¾³ýÒ»·âÓÊ¼þÊ±Í¨ÖªÏÂÁÐ·þÎñÆ÷£º",
...
subdomains:",
	...
	"zh" => "¶þ¼¶ÓòÃûÊ¹ÓÃCNAME¶ø²»Ê¹ÓÃA¼ÇÂ¼£º",
...
$txt_cfg_use_nated_vhost = array(
	...
	"zh" => "ËùÓÐÐéÄâÖ÷»ú¶¼¼àÌýÓÚÄÚÍøµØÖ·(NAT)£º",
...
$txt_cfg_hide_password = array(
	...
	"zh" => "Ê¹ÓÃDTC¿ØÖÆÃæ°åÊ±Òþ²ØÃÜÂë£º",
...
ÜÔÉÍ:",
	...
	"zh" => "DTCÅäÖÃÎÄ¼þÂ·¾¶¡£qmail¡¢apache¡¢named µÈ·þÎñ¶¼»áÊ¹ÓÃÕâ¸öÄ¿Â¼£º",
...
$txt_cfg_phplib_path = array(
	...
	"zh" => "PHP¿âÎÄ¼þÂ·¾¶(ÓÃ\":\"·Ö¸ô<br>ÐÂ°²×°µÄDTC¿ØÖÆÃæ°åÐëÖØÐÂÉèÖÃ)£º",
...
$txt_cfg_phplib2_path =array(
	...
	"zh" => "PHP¸½¼Ó¿âÎÄ¼þÂ·¾¶(ÓÃ\":\"·Ö¸ô<br>ÐÂ°²×°µÄDTC¿ØÖÆÃæ°åÎÞÐëÖØÐÂÉèÖÃ)£º",
...
$txt_cfg_named_main_zonefile =array(
	...
	"zh" => "Ö÷DNS·þÎñÆ÷zonefiles´æ·ÅÂ·¾¶£º",
...
$txt_cfg_named_cache_slave_zonefile =array(
	...
	"zh" => "´ÓDNS·þÎñÆ÷zonefiles´æ·ÅÂ·¾¶(»º´æ)£º",
