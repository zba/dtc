 ...
 * @package DTC
 * @copyright LGPL
 * @version $Id: dtc_config_strings.php,v 1.70 2007/06/15 21:23:37 seeb Exp $
 * $Log: dtc_config_strings.php,v $
 * Revision 1.70  2007/06/15 21:23:37  seeb
 * Polish translation upgrade
 *
 *
 **/
...
$txt_cfg_ftp_backup_ftp_backup_config = array(
	...
	"nl" => "FTP backup configuratie",
	"ru" => "TRANS FTP backup configuration",
	"de" => "TRANS FTP backup configuration",
	"zh" => "ÅäÖÃFTP±¸·İ²ÎÊıÅäÖÃ",
	"pl" => "Konfiguracja kopii FTP",
...
$txt_cfg_category_description = array(
	...
	"hu" => "TRANS ",
	"it" => "TRANS ",
	"nl" => "Omschrijving van de categorie ",
	"ru" => "TRANS ",
	"de" => "TRANS ",
	"zh" => "Àà±ğÃèÊö",
	"pl" => "Opis kategorii",
...
"ru" => "TRANS Domain name registration",
...
"nl" => "MX en NS backup servers",
"ru" => "TRANS MX and NS backup servers",
...
"nl" => "IP addressen en netwerk",
"ru" => "TRANS IP addresses and network",
"de" => "TRANS IP addresses and network",
"zh" => "ÉèÖÃÍøÂç²ÎÊı",
"pl" => "Adres IP i sieci ",
"se" => "TRANS IP addresses and network",
"es" => "Direcciones IP y red",
...
"nl" => "Periode VPS renewal email Herinnering",
"ru" => "TRANS VPS renewal email reminders periodicity",
"de" => "TRANS VPS renewal email reminders periodicity",
"zh" => "Éè¶¨VPS¸üĞÂµÄÓÊ¼şÌáĞÑµÄÖÜÆÚ",
"pl" => "Przypomnienie mailowe o odnowieniu VPS",
...
while others are made of a unique value. The message templates
are stored in /etc/dtc, and if not present in: ",
"zh" => "TRANSÕâĞ©Êı×ÖÌáÊ¾ÁË¾àÀë¹ıÆÚ£¨»òÒÑ¾­¹ıÆÚ£©µÄÌìÊı¡£
¼´½«£¨»òÒÑ¾­£©¹ıÆÚµÄÊ±¼ä¾¯¸æÊ¹ÓÃ | ·Ö¸ô¿ªÀ´£¬
Ò²¿ÉÒÔÊÇÎ¨Ò»µÄÖµ¡£¾¯¸æĞÅÏ¢µÄÄ£°åÎÄ¼ş´æ·ÅÔÚ£º /etc/dtc, and if not present in:",
...
"nl" => "Laatste Waarschuwingen: ",
"ru" => "TRANS Last Warnings: ",
"de" => "TRANS Last Warnings: ",
"zh" => "ÉÏÒ»Ìõ¾¯¸æ£º",
"pl" => "Ostatnie ostrze¿enie: ",
...
"nl" => "Sluitings Waarschuwing: ",
"ru" => "TRANS Shutdown warning: ",
"de" => "TRANS Shutdown warning: ",
"zh" => "¹Ø±Õ¾¯¸æĞÅÏ¢£º",
"pl" => "Ostrze¿enie o wy³±czeniu us³ug: ",
...
want to have conflicts (and prevent apache from restarting)!",
"nl" => "Let erop om het het SSL IP adress van het controle paneel zelf niet toe te voegen 
om conflicten the vermijden (en Apache van een herstart te weerhouden)!",
...
want to have conflicts (and prevent apache from restarting)!",
"zh" => "Çë×¢Òâ£¬Èç¹û²»Ïë³öÏÖ³åÍ»£¨Õâ¿ÉÄÜ»áÊ¹apacheÎŞ·¨ÖØÆô£©
£¬Çë²»Òªµ¥¶ÀÌîÈë¿ØÖÆÃæ°åµÄSSL IP£¡",
...
"nl" => "Support ticket configuratie",
"ru" => "TRANS Support ticket configuration",
"de" => "TRANS Support ticket configuration",
"zh" => "ÅäÖÃ Support ticket",
"pl" => "Konfiguracja pomocy technicznej",
...
"nl" => "Lijst van de administrators die request for support messages ontvangen:",
...
"zh" => "´¦ÀíÖ§³ÖÇëÇóµÄ¹ÜÀíÔ±ÁĞ±í£º",
"pl" => "Lista administratorów wysy³aj±cych zapytania do pomocy technicznej:",
...
"nl" => "Ticket categorieen",
"ru" => "TRANS Ticket categories:",
"de" => "TRANS Ticket categories:",
"zh" => "Ticket ·ÖÀà£º",
"pl" => "Kategoria pomocy technicznej:",
...
$txt_cfg_use_javascript = array(
	...
	"it" => "Usa javascript:",
	"nl" => "Gebruik javascript:",
	"ru" => "TRANS Use javascript:",
	"de" => "JavaScript verwenden:",
	"zh" => "ÊÇ·ñÊ¹ÓÃjavascript£º",
	"pl" => "U¿yj JavaScript'u :",
	"se" => "TRANS Use javascript:",
	"es" => "Usar javascript:",
	"pt" => "Usar JavaScript  :"
	);
...
$txt_cfg_name_zonefileconf_title =array(
	...
	"se" => "TRANS Named zonefiles",
	"es" => "Archivos de Zona de Named",
...
$txt_cfg_payconf_title = array (
	...
	"nl" => "Betalings gateway",
	"ru" => "TRANS: Pay gateway",
	"de" => "Zahlungsgateway",
	"zh" => "ÉèÖÃ¸¶¿î½Ó¿Ú",
	"pl" => "System p³atno¶ci",
	"se" => "TRANS Pay gateway",
	"es" => "Pasarela de pago",
