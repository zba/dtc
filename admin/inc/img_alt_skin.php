 ...
 * @version $Id: img_alt_skin.php,v 1.1 2006/05/21 17:14:56 seeb Exp $
 ...
 * Revision 1.1  2006/05/21 17:14:56  seeb
...
require("../../shared/inc/skin.class.php");


$skin=new getskin($conf_mysql_host,$conf_mysql_login,$conf_mysql_pass, $conf_mysql_db);
$config_skin=$skin->config_skin;
...
$im = ImageCreateFromPng($imglong) or die ("Nie mozna znalezc pliku");
//$im = ImageCreateFromPng("../gfx/skin/tex/imglong.png") or die ("Nie mozna znalezc pliku");
}
else{
$im = ImageCreateFromPng($imgshort) or die ("Nie mozna znalezc pliku");
//$im = ImageCreateFromPng("../gfx/skin/tex/imgshort.png") or die ("Nie mozna znalezc pliku");
}
