...
$txt_renew_total_recurring_incomes_per_month = array(
	...
	"de" => "Gesamtumsatz aus Abonnements pro Monat:",
	"zh" => "Ã¿ÔÂÑ­»·ÊÕÒæ×ÜÊý£º",
	"pl" => "Wszystkich nowych miesiêcznie:",
...
$txt_renew_shared_renewals = array(
	...
	"de" => "Verlängerung von Shared Hosting:",
	"zh" => "¹²ÏíÖ÷»ú¸üÐÂ£º",
	"pl" => "Odnowienia hostingu:",
...
$txt_renew_no_shared_account_expired = array(
	...
	"de" => "Keine abgelaufenen Shared-Hostings.",
	"zh" => "Ã»ÓÐÒÑ¹ýÆÚµÄ¹²ÏíÖ÷»úÕËºÅ¡£",
	"pl" => "Przedawnione konta bez hostingu.",
...
$txt_renew_client_name_not_found = array(
	...
	"de" => "Kundenname nicht gefunden!",
	"zh" => "Ã»ÓÐÕÒµ½Ïà¹ØµÄ¿Í»§Ãû³Æ£¡",
...
$txt_renew_no_ssl_ip_expired = array(
	...
	"de" => "keine abgelaufenen SSL-IP-Adressen",
	"zh" => "Ã»ÓÐÒÑ¹ýÆÚµÄSSL IP",
	"pl" => "Przedanienia bez SSL",
...
$txt_renew_vps_renewals = array(
	...
	"de" => "Verlängerung von VPS-Servern",
	"zh" => "VPS ¸üÐÂ",
	"pl" => "Odnowienia VPS",
...
$txt_renew_no_vps_expired = array(
	...
	"de" => "keine VPS-Server abgelaufen",
	"zh" => "Ã»ÓÐÒÑ¹ýÆÚµÄVPS",
	"pl" => "Przedawnienia bez VPS",
...
$txt_renew_dedicated_servers_renewals = array(
	...
	"de" => "Verlängerung von dedizierten Servern",
	"zh" => "¶ÀÁ¢Ö÷»ú¸üÐÂ",
	"pl" => "Odnoweienia serwerów dedykowanych",
...
$txt_renew_no_dedicated_server_expired = array(
	...
	"de" => "keine dedizierten Server abgelaufen",
	"zh" => "Ã»ÓÐÒÑ¹ýÆÚµÄ¶ÀÁ¢Ö÷»ú",
	"pl" => "Przedawnienia serwerów nie dedykowanych",
...
$txt_renew_ssl_ips_renewals = array(
	...
	"de" => "Verlängerung von SSL-IP-Adressen",
	"zh" => "SSL IPs ¸üÐÂ",
	"pl" => "Odnowienia IP dla SSL",
...
$txt_renew_customer_renewals = array(
	...
	"de" => "Vertragsverlängerungen",
	"zh" => "Customer ¸üÐÂ",
	"pl" => "Odnownienie klienta",
