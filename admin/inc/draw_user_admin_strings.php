 ...
 * @package DTC
 * @copyright LGPL
 * @version $Id: draw_user_admin_strings.php,v 1.5 2007/06/15 19:19:44 seeb Exp $
 * $Log: draw_user_admin_strings.php,v $
 * Revision 1.5  2007/06/15 19:19:44  seeb
 * Polish translation ready to use.
 *
 **/
...
$txt_dua_cannot_find_payment = array(
	...
	"nl" => "Kan betaling niet vinden !",
	"ru" => "TRANS Cannot find payment!",
	"de" => "TRANS Cannot find payment!",
	"zh" => "Ã»ÓÐÕÒµ½¸¶¿î¼ÇÂ¼",
	"pl" => "Nie mo¿na odnale¼æ p³atno¶ci!",
...
$txt_dua_ssl_token_renewal = array(
	...
	"nl" => "Vernieuw SSL Token",
	"ru" => "TRANS SSL Token renewal",
	"de" => "TRANS SSL Token renewal",
	"zh" => "¸üÐÂSSLÖ¤Êé",
	"pl" => "Wykup odnowienie certyfikatu SSL",
...
$txt_dua_cannot_find_server = array(
	...
	"nl" => "Kan server niet in de database vinden!",
	"ru" => "TRANS cannot find server in db!",
	"de" => "TRANS cannot find server in db!",
	"zh" => "ÔÚÊý¾Ý¿âÖÐÃ»ÓÐÕÒµ½¸ÃserverµÄÅäÖÃ£¡",
	"pl" => "Nie mozna znale¼æ serwera w bazie!",
...
$txt_dua_no_pending_support_tickets = array(
	...
	"nl" => "Geen openstaande support tickets!",
	"ru" => "TRANS No pending support tickets!",
	"de" => "TRANS No pending support tickets!",
	"zh" => "Ã»ÓÐÎ´¾öµÄ£¿£¡",
	"pl" => "Nie ma nowych wiadomo¶ci dla pomocy technicznej!",
...
$txt_dua_cannot_find_ticket = array(
	...
	"nl" => "Kan ticket niet vinden!",
	"ru" => "TRANS Cannot find ticket!",
	"de" => "TRANS Cannot find ticket!",
	"zh" => "Ã»ÓÐÕÒµ½ÏàÓ¦µÄÖ÷Ìâ£¡",
	"pl" => "Nie mo¿na znale¼æ tiketu!",
...
$txt_dua_ticket_type_not_found = array(
	...
	"nl" => "Type niet gevonden!",
	"ru" => "TRANS type not found!",
	"de" => "TRANS type not found!",
	"zh" => "Ã»ÓÐÕÒµ½Ïà¹ØµÄÀàÐÍ£¡",
	"pl" => "Wpis nie znaleziony!",
...
$txt_dua_cannot_find_product_in_db = array(
	...
	"nl" => "Kan product niet in database vinden!",
	"ru" => "TRANS Cannot find product in db!",
	"de" => "TRANS Cannot find product in db!",
	"zh" => "ÔÚÊý¾Ý¿âÖÐÃ»ÓÐ·¢ÏÖ¸Ã¿î²úÆ·£¡",
	"pl" => "Nie mo¿na znale¼æ produktu w bazie!",
