...
if( !$_SERVER["PHP_AUTH_USER"] ){
	...
	$q = "SELECT * FROM $pro_mysql_tik_admins_table WHERE pseudo='".mysql_escape_string($_SERVER['PHP_AUTH_USER'])."' AND tikadm_pass='".mysql_escape_string($_SERVER['PHP_AUTH_PW'])."';";
