...
if( !isset($_SERVER["PHP_AUTH_USER"]) || $_SERVER["PHP_AUTH_USER"] == ""){
	...
	$q = "SELECT * FROM tik_admins WHERE pseudo='".mysql_real_escape_string($_SERVER['PHP_AUTH_USER'])."' AND (tikadm_pass='".mysql_real_escape_string($_SERVER['PHP_AUTH_PW'])."' OR tikadm_pass=PASSWORD('".mysql_real_escape_string($_SERVER['PHP_AUTH_PW'])."'));";
