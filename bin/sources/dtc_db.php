...
"tables" => array(
	...
	"clients" => array(
		"vars" => array(
			"id" => "int(9) NOT NULLauto_increment",
	...
	"commande" => array(
		"vars" => array(
			"id" => "mediumint(9) NOT NULLauto_increment",
	...
	"ftp_accounting" => array(
		"vars" => array(
			"id" => "int(14) NOT NULLauto_increment",
	...
	"ftp_logs" => array(
		"vars" => array(
			...
			"success" => "char(1) NULL",
			"ui" => "bigint(20) NOT NULLauto_increment"
			),
		"keys" => array(
			"PRIMARY" => "(ui)"
			)
	...
	"handle" => array(
		"vars" => array(
			"id" => "int(16) NOT NULLauto_increment",
	...
	"subdomain" => array(
		"vars" => array(
			"id" => "int(12) NOT NULLauto_increment",
