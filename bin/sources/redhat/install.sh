...
echo " - Add DAG apt repository, as per http://dag.wieers.com/home-made/apt/FAQ.php#B"
echo " - mod_log_sql (apt-get install mod_log_sql) and enable the module in /etc/httpd/conf.d/mod_log_sql.conf"
echo " - clamav (apt-get install mod_log_sql)"
echo " - amavisd-new (apt-get install mod_log_sql)"
